...
public class Application1 {
    public static void main(String[] args) {
        ...
        *  2-1. 자동형변환ㅇ이 적용되지 않는 경우 강제 형변환이 필요하다.
        * */

        /* 필기. 점점 더 큰 자료형으로 데이터를 옮겨도 문제 없이 자동 형변환 처리가 된다.*/
        byte bnum = 1;
        short snum = bnum;
        int inum = snum;
        long lnum = inum;
...
//        int result1 = num1 + num2;     // 자동으로 큰 쪽 자료형인 long으로 병경 후 계산 하기 때문에 int형 변수에 담을 수 없다.
        ...
        * 이 때 데이터 손실이 없기 때문에 자동형변환이 가능하다.
        * */
        ...
        /* 논리형은 형변환 규칙에서 제외된다.
        * 어느 자료형이든 boolean을 형변환 해서 담을수 없다.*/
        boolean isTrue = true;
//        byte b = isTrue;
//        int i = isTrue;
//        char c = isTrue;
